...
public class Invoice 
{
	...
	public Invoice(String invoiceNumber, LocalDate date, String customerName, String customerId, String serviceName,
			double price, String discountType, Integer manualDiscountPercent, Integer defaultDiscountPercent, double discountAmount, double gstAmount,
			double finalAmount)
	{
		super();
